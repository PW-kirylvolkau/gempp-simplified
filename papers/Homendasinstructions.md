...
the task can be carried out in teams of no more than four people in one of two versions:
...
Input data will be saved in a format common to all teams, assuming data interchangeability between teams. These will be text files containing descriptions of two graphs:
...
The solution to the task will be a report and a computer program compiled and run on computers in laboratory room 301 using Windows. The following concepts should be developed:
...
The laboratory task can be carried out in the following mode:
...
Laboratory meetings will be carried out:
a) Fridays, 12:15-13:35 and 14:15-15:45, room 301,
b) Fridays, 18:30-20:00, Teams,
If no one shows up for the meeting within the first quarter of an hour,
